...
public class AboutLayout {
	...
	public AboutLayout(JFrame mainFrame) {
		...
		home.setName("Home");
		home.setPreferredSize(new Dimension(home.getHeight(), 50));
		...
		characteristicsString = " Chesed (חֶסֶד) – <i> Loving-Kindness </i>" + "<br>"
				...
				+ "Tiferet (תִּפְאָרָה) – <i> Harmony and Compassion </i>" + "<br>" + "Netzach (נֶצַח) – <i> Endurance </i>" + "<br>"
				+ "Hod (הוֹד) – <i> Humility </i>" + "<br>" + "Yesod (יְסוֹד) – <i> Bonding </i> " + "<br>"
